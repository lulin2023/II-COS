...
plotreg_stop <- ggarrange(p_FSR, p_ES, p_Time,ncol=3, nrow=1, common.legend = FALSE, legend = 'none',
                          font.label = list(size = 20, face = "bold"))
pdf(file = "plotreg_stop.pdf",width = 12,height = 5) 
plotreg_stop
dev.off()
...
plot_reg <- ggarrange(p1, p2, ncol=2, nrow=1, common.legend = TRUE, legend="bottom", # 添加标签
                      font.label = list(size = 20, face = "bold"))
pdf(file = "plot_reg.pdf",width = 10,height = 4) 
plot_reg
dev.off()
